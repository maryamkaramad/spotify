...
export default function Home() {
  return (
    <Grid container xs={10} sx={{ background: "linear-gradient(180deg, #3C3F41 0%, #000000 100%)", color: "white" }} justifyContent={"flex-start"} flexDirection={"column"} gap={2} p={2} overflowY={"scroll"}>
